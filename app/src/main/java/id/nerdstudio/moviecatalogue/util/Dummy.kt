    ...
    fun dummyMovies(): List<Movie> {
        return listOf(
            ...
            Movie(
                ...
                releaseDate = "January 31, 2019"
            ),
            Movie(
                id = 297802,
                voteAverage = 6.8F,
                title = "Aquaman",
                posterPath = "movie_aquaman",
            ...
            Movie(
                ...
                posterPath = "movie_mortal_engines",
            ...
            Movie(
                ...
                voteAverage = 4.9F,
                title = "T34",
                posterPath = "movie_t34",
                overview = "n 1944, a courageous group of Russian soldiers managed to escape from German captivity in a half-destroyed legendary T-34 tank. Those were the times of unforgettable bravery, fierce fighting, unbreakable love, and legendary miracles.",
                releaseDate = "December 27, 2018"
            )
        )
    }

    fun dummyTvShows(): List<TvShow> {
        return listOf(
            TvShow(
                name = "The Flash",
            ...
            TvShow(
                ...
                posterPath = "tv_gotham"
            ),
            TvShow(
                name = "Fairy Tail",
                firstAirDate = "2009-10-12",
                id = 46261,
                voteAverage = 6.4F,
            ...
            TvShow(
                ...
                posterPath = "tv_naruto_shippuden"
            ),
            TvShow(
                id = 79501,
                name = "Doom Patrol",
            ...
            TvShow(
                ...
                name = "Supergirl",
                voteAverage = 5.78F,
                posterPath = "tv_supergirl",
                firstAirDate = "2015-10-26",
